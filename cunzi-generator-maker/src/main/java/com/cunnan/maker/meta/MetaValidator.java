...
import com.cunnan.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo : modelInfoList) {
            ...
            if (StrUtil.isEmpty(modelInfoType)) {
                modelInfo.setType(ModelTypeEnum.SRTING.getValue());
            }
        }
    }
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String description = StrUtil.emptyToDefault(meta.getDescription(), "my-generator description");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "cunnan");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.cunnan");
